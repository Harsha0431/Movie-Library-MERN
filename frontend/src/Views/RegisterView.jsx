    ...
    <div className="w-[100dvw] h-[100dvh] overflow-hidden justify-center flex items-center px-4 max-ssm:px-2">
      ...
      >
        <header className="w-full text-center flex justify-center flex-col items-center">
          ...
          />
          <h3 className="tracking-normal m-0 font-josefin capitalize text-[calc(18px+0.3dvw)] -mt-4 text-white">
            Sign up
          </h3>
          <p className="m-0 -mt-0.5 text-[#f5f5f5e6] tracking-wide capitalize text-[calc(14px+0.2dvw)]">
        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-y-1.5">
            <button
              type="submit"
              className="bg-[#e50914] capitalize hover:bg-[#e50914e7] border-none transition-colors shadow-md text-white px-2 py-2 font-semibold text-center rounded-md"
            >
              Sign up
            </button>
            ...
            <div className="flex justify-center gap-x-1 mt-3 max-ssm:mt-2 text-gray-200 transition-all text-sm">
              <span>
                ...
                <Link to={'/login'} className="underline hover:text-white font-[600] ">
                  Log in
                </Link>
              </span>
            </div>
